...
// Static import so the Cloudflare Worker bundle includes h3/server-entry.
// A dynamic import() gets code-split into a chunk the Worker runtime cannot
// resolve ("No such module 'assets/h3-v2'"), causing every request to 500.
